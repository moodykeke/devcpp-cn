...
type
  ...
  public
    ...
    procedure LoadMsg(const FileName: String; var strList: TStringList);
...
begin
  // Load file from languages directory
  MsgFile := ValidateFile(Filename, devDirs.Lang);
  MsgFile := ChangeFileExt(MsgFile, '.msg');
  if FileExists (MsgFile) then begin
    strlist.LoadFromFile(MsgFile);
    strlist.Delete(0);
  end;
end;
