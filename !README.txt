Compiling Dev-C++ with Delphi XE2 or higher. (don't use old versions)
...
The main executable devcpp.exe can be built using the following steps:
	...
	(Open the package, then compile and build.
	Next, In the Project Manager right click the *.bpl, "install".)
...
This process has only been tested using Delphi XE2. The code base should be 
compatible with more recent versions of Delphi, but there is no guarantee 
anything will work.
