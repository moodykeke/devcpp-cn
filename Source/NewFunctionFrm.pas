...
begin
  ...
  MainForm.CppParser.GetSourcePair (st^._DefinitionFileName, CppFname, fName); //(st^._DefinitionFileName, CppFname, fName);
  ...
  e.Text.BeginUpdate;
  try
    e.Text.UncollapseAroundLine(Line); // uncollapse folds around this line  //abli debug
